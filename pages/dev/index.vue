<template>
  <div>
    <div class="w-80 h-80 flex items-center justify-center">
      <nj-spinner v-if="pendingDogs" />
      <img v-else :src="dogs.message" alt="dog" class="h-full">
    </div>
    <button class="p-4 bg-primary-pink rounded m-4" @click="refreshDogs">
      Reload Image
    </button>
    <h2>{{ computedProp }}</h2>
    ...
    <div>
      ...
      <button class="p-4 bg-primary-pink rounded m-4" @click="store.increment(2)">
